...
# All artefacts must live under .research/iteration6/
BASE_DIR = Path(".research/iteration6")
...
def run_experiment_1(cfg: Dict):
    ...
    All JSON results are written to .research/iteration6/ and all figures are
    written to .research/iteration6/images/ in accordance with the mandatory
    path constraints.
    """
